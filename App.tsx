...
import '@tensorflow/tfjs-react-native'; // Ensure this import is present
...
export default function App() {
  ...
  async function initializeTensorFlow() {
     tf.ready().then((res) => {
      console.log('TensorFlow.js is ready!', res);
     }).catch((error) => {
      console.log('TensorFlow.js error', error);
     });
   // await tf.setBackend('rn-webgl'); // Use 'rn-webgl' for React Native
